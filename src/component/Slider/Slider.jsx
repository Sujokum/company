  ...
  >
    ...
    <div className="h-[78vh]  relative w-full slide1  flex  HomeBg  justify-center items-center max-md:px-[100px] md:px-[160px] xl:px-[150px] 2xl:px-[160px]" >
                    ...
                    <div className='flex  relative justify-between items-center  h-full w-full ' >
                        ...
                        <p className='  text-gray max-sm:w-[80%]  max-xl:w-[40%] xl:w-[40%]  2xl:w-[40%] font-poppins max-md:text-md md:text-md xl:text-md 2xl:text-lg ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed d eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <div className="h-[78vh]  relative w-full slide1  flex  HomeBg  justify-center items-center max-md:px-[100px] md:px-[160px] xl:px-[150px] 2xl:px-[160px]" >
                    ...
                    <div className='flex  relative justify-between items-center  h-full w-full ' >
                        <div className="flex uppercase    max-sm:p-10  flex-col  font-steelfish  gap-3" >
                        <h1 className='text-blue font-bold max-md:text-7xl md:text-8xl xl:text-9xl ' >GRAPHICS</h1>
                        <h1 className='text-gray font-bold max-md:text-7xl md:text-8xl xl:text-9xl  ' >Design</h1>
                        <p className='  text-gray max-sm:w-[80%]  max-xl:w-[40%] xl:w-[40%]  2xl:w-[40%] font-poppins max-md:text-md md:text-md xl:text-md 2xl:text-lg ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed d eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                        <button className='mt-5 max-md:w-[160px] md:w-[160px] 2xl:w-[160px] px-[30px] font-poppins py-[9px] bg-orange shadow-md text-white text-[14px] rounded-3xl' >
                            Get a Quote</button>
    ...
    <div className="h-[78vh]  relative w-full slide1  flex  HomeBg  justify-center items-center max-md:px-[100px] md:px-[160px] xl:px-[150px] 2xl:px-[160px]" >
                    ...
                    <div className='flex  relative justify-between items-center  h-full w-full ' >
                        <div className="flex uppercase    max-sm:p-10  flex-col  font-steelfish  gap-3" >
                        <h1 className='text-blue font-bold max-md:text-7xl md:text-8xl xl:text-9xl ' >Data</h1>
                        <h1 className='text-gray font-bold max-md:text-7xl md:text-8xl xl:text-9xl  ' >Science</h1>
                        <p className='  text-gray max-sm:w-[80%]  max-xl:w-[40%] xl:w-[40%]  2xl:w-[40%] font-poppins max-md:text-md md:text-md xl:text-md 2xl:text-lg ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed d eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                        <button className='mt-5 max-md:w-[160px] md:w-[160px] 2xl:w-[160px] px-[30px] font-poppins py-[9px] bg-orange shadow-md text-white text-[14px] rounded-3xl' >
                            Get a Quote</button>
                        </div>
    ...
    <div className="h-[78vh]  relative w-full slide1  flex  HomeBg  justify-center items-center max-md:px-[100px] md:px-[160px] xl:px-[150px] 2xl:px-[160px]" >
                    ...
                    <div className='flex  relative justify-between items-center  h-full w-full ' >
                        <div className="flex uppercase    max-sm:p-10  flex-col  font-steelfish  gap-3" >
                        <h1 className='text-blue font-bold max-md:text-7xl md:text-8xl xl:text-9xl ' >BLOCKCHAIN</h1>
                        <h1 className='text-gray font-bold max-md:text-7xl md:text-8xl xl:text-9xl  ' >DEVELPOMENT</h1>
                        <p className='  text-gray max-sm:w-[80%]  max-xl:w-[40%] xl:w-[40%]  2xl:w-[40%] font-poppins max-md:text-md md:text-md xl:text-md 2xl:text-lg ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed d eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                        <button className='mt-5 max-md:w-[160px] md:w-[160px] 2xl:w-[160px] px-[30px] font-poppins py-[9px] bg-orange shadow-md text-white text-[14px] rounded-3xl' >
                            Get a Quote</button>
    ...
    <div className="h-[78vh]  relative w-full slide1  flex  HomeBg  justify-center items-center max-md:px-[100px] md:px-[160px] xl:px-[150px] 2xl:px-[160px]" >
                    ...
                    <div className='flex  relative justify-between items-center  h-full w-full ' >
                        <div className="flex uppercase    max-sm:p-10  flex-col  font-steelfish  gap-3" >
                        <h1 className='text-blue font-bold max-md:text-7xl md:text-8xl xl:text-9xl ' >CMS</h1>
                        <h1 className='text-gray font-bold max-md:text-7xl md:text-8xl xl:text-9xl  ' >DEVELPOMENT (WORDPRESS) </h1>
                        <p className='  text-gray max-sm:w-[80%]  max-xl:w-[40%] xl:w-[40%]  2xl:w-[40%] font-poppins max-md:text-md md:text-md xl:text-md 2xl:text-lg ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed d eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                        <button className='mt-5 max-md:w-[160px] md:w-[160px] 2xl:w-[160px] px-[30px] font-poppins py-[9px] bg-orange shadow-md text-white text-[14px] rounded-3xl' >
                            Get a Quote</button>
                        </div>
