...
<>
    ...
    <div className='flex flex-col items-center  w-full py-[22px] ' >
        <h1 className='text-[90px] max-md:text-[50px] font-steelfish text-center font-bold text-gray ' > <span className='text-white' > Partnership  </span> WE FOLLOW</h1>
        <p className='text-center font-poppins max-md:w-[80%]  max-md:px-4 text-[16px] text-white w-[430px]' >
...
<div className='w-full  py-[100px] gap-[20px] flex justify-between max-lg:justify-center flex-wrap max-md:px-[20px] lg:px-[101px] ' >
   {
    data?.map((val)=>(
